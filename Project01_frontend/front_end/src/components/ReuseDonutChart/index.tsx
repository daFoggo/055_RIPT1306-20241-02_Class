...
import { IReuseDonutChartProps } from "@/models/ReuseDonutChart/type";
    ...
    () =>
      Object.fromEntries(
        Object.keys(data).map((key, index) => [
          ...
          {
            label: key,
            color: chartColors[index % chartColors.length] || '#000000',
          },
        ])
      ),
    [data, chartColors]
            ...
            <PieChart>
              ...
              >
                {chartData.map((entry, index) => (
                  <Cell
                    key={`cell-${index}`}
                    fill={chartColors[index % chartColors.length] || '#000000'}
                  />
                ))}
                <Label
                  content={({ viewBox }) => {
